...
class McGovernService extends AppService
{
    ...
    {
        $cmd = <<<HERE
        select e.idEntity2 idEntity, count(distinct f.idFrame) f, count(distinct lu.idLU) l
...
HERE;
        ...
        $frames = collect($query)->keyBy('idEntity')->all();
ddump($frames);
        $cmd = <<<HERE
...
HERE;
        ...
        return [
            ...
            'hFrames' => $frames['1550220']->f,
            'hLus' => $frames['1550220']->l,
            'vFrames' => $frames['1554179']->f,
            'vLus' => $frames['1554179']->l,
        ];
    }
